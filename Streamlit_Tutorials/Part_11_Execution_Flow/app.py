...
def update_counter():
    """
    This fragment maintains its own counter in Session State.    It increments the counter and displays it.    The button within the fragment triggers a rerun of the fragment only.
    """
